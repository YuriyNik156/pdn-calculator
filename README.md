...
## Структура проекта
    ...
    │   ├── utils.py            # Вспомогательные функции (нормализация, маскирование)
    │   ├── logger.py           # Настройка логирования
    │   └── config.py           # Конфигурация
    │
    ├── tests/
    │   ├── test_pdn.py         # Тесты эндпоинта и логики
    │   └── conftest.py
    │
    ├── Dockerfile
    ├── requirements.txt
...
Проект рассчитан на 3–5 дней:

1. Этап 0 (День 1):

* Анализ ТЗ и выделение MVP
* Создание репозитория и README
...
* Реализация /pdn/calc
* Pydantic-схемы
* Простейшая бизнес-логика расчёта

3. Этап 2 (День 3–4):

* Логирование с маскированием PII
* Нормализация периодичности платежей
* Тесты и документация

4. Этап 3 (День 5):

* Dockerfile
* Рефакторинг и финальное ревью кода
